...
export class HomeComponent implements OnInit {
  ...
  constructor() {
    ...
    this.ImageURLs.push("../assets/images/grove1.jpg");
    this.ImageURLs.push("../assets/images/speaker2.jpg");
    this.ImageURLs.push("../assets/images/trout2.jpg");
    this.ImageURLs.push("../assets/images/clemente2.jpg");
    this.ImageURLs.push("../assets/images/mathews1.jpg");
    this.ImageURLs.push("../assets/images/acuna1.jpg");
    this.ImageURLs.push("../assets/images/harper1.jpg");
    this.ImageURLs.push("../assets/images/jrod1.jpg");
    this.ImageURLs.push("../assets/images/kirkgibson1.jpg");
    this.ImageURLs.push("../assets/images/nolanryan2.jpg");
    this.ImageURLs.push("../assets/images/ohtani2.jpg");
    this.ImageURLs.push("../assets/images/61yankees.jpg");
    this.ImageURLs.push("../assets/images/trio1.jpg");
    this.ImageURLs.push("../assets/images/helton2.JPG");
    this.ImageURLs.push("../assets/images/judge2.jpg");
    ...
    this.ImageURLs.push("../assets/images/ozzie2.jpg");
    this.ImageURLs.push("../assets/images/ohtani3.png");
    this.ImageURLs.push("../assets/images/griffey2.jpg");
    this.ImageURLs.push("../assets/images/edmonds1.jpg");
    this.ImageURLs.push("../assets/images/ohtani4.jpg");
    this.ImageURLs.push("../assets/images/puckett2.jpg");
    this.ImageURLs.push("../assets/images/ozzie3.jpg");
    this.ImageURLs.push("../assets/images/ruth60th.jpg");
    this.ImageURLs.push("../assets/images/wagner2.jpg");
    this.ImageURLs.push("../assets/images/mantle3.jpg");
